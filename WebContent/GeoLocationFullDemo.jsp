...
<html>
   ...
   <body>
      ...
      <div id="g-information">
         <ul>
            <li>
               Your position is <span id="latitude" class="g-info">unavailable</span>¡Æ latitude,
               <span id="longitude" class="g-info">unavailable</span>¡Æ longitude (with an accuracy of
            ...
            <li>You're <span id="heading" class="g-info">unavailable</span>¡Æ from the True north</li>
            <li>You're moving at a speed of <span id="speed" class="g-info">unavailable</span>¡Æ meters/second</li>
